...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ra(){return new jt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xr(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function sa(){return new jt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xr(),fragmentShader:`
...
`,qr=new dd,ki=new wt(55,window.innerWidth/(window.innerHeight*2),.1,500),Zi=new Za({antialias:!0});Zi.setSize(window.innerWidth,window.innerHeight*2);document.body.appendChild(Zi.domElement);const Yr=new Bt(new ui(1,1),new jt({uniforms:{u_time:{value:0}},vertexShader:ja,fragmentShader:pd}));Yr.position.y=1.5;qr.add(Yr);const Kr=new Bt(new ui(1,1),new jt({uniforms:{u_time:{value:0}},vertexShader:ja,fragmentShader:md}));Kr.position.y=0;qr.add(Kr);ki.position.z=5;window.addEventListener("resize",()=>{ki.aspect=window.innerWidth/(window.innerHeight*2),ki.updateProjectionMatrix(),Zi.setSize(window.innerWidth,window.innerHeight*2)});function $a(i){requestAnimationFrame($a),Yr.material.uniforms.u_time.value=i/1e3,Kr.material.uniforms.u_time.value=i/1e3,Zi.render(qr,ki)}$a();
